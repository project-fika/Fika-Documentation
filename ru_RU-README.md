...
<details>
	...
	<ol>
		<li><a href="#what-is-mpt">Что такое Fika</a></li>
		<li><a href="#license">Лицензия</a></li>
		<li>
           	<a href="#prerequisites">Требования</a>
            <ul>
                <li><a href="#hosting">Хост</a></li>
                <li><a href="#client">Клиент</a></li>
            </ul>
        </li>
        <li><a href="#hardware-requirements">Системные требования</a></li>
		<li>
	            <a href="#installation">Установка</a>
	            <ul>
	                <li><a href="#host-using-port-forwarding">Хост с использованием перенаправления портов</a></li>
	                <li><a href="#host-using-a-vpn">Хост с использованием ВПН</a></li>
	                <li><a href="#client-using-port-forwarding">Клиент с использованием перенаправления портов</a></li>
	                <li><a href="#client-using-a-vpn">Клиент с использованием ВПН</a></li>
	            </ul>
        </li>
        <li><a href="#features-and-configuration">Особенности и настройка</a></li>
